...
/**
 * Trigger a browser download for a Blob. The common create-anchor/click/cleanup dance,
 * previously copy-pasted independently across ~15 files in this codebase.
 * @param {Blob} blob The data to download
 * @param {String} filename The output filename, including extension
 */
