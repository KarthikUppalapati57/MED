...
const DocumentViewer = React.lazy(() => import('@/modules/invoices/components/DocumentViewer'));
const ValidationDialog = React.lazy(() => import('@/modules/invoices/components/ValidationDialog'));
const EmailIngestionDialog = React.lazy(() => import('@/modules/invoices/components/EmailIngestionDialog'));
const CreditRequestDialog = React.lazy(() => import('@/modules/invoices/components/CreditRequestDialog'));
const MobileReceiptCapture = React.lazy(() => import('@/modules/invoices/components/MobileReceiptCapture'));
