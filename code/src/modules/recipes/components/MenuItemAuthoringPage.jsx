...
const initialForm = () => ({
  name: '', description: '', recipeTypeId: '', category: 'main_course', status: 'active',
...
export default function MenuItemAuthoringPage({ products = [], preparedItems = [], locations = [], conversions = [] }) {
  ...
  const save = async () => {
    if (saving) return;
    const errors = validateMenuItemAuthoring(form);
