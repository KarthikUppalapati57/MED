    ...
    <div className="min-h-screen bg-muted/40 flex flex-col">
      ...
      <div className="flex-1 max-w-4xl w-full mx-auto p-6 md:p-12">
        <div className="bg-card rounded-2xl shadow-sm border border-border p-8 md:p-12">
          <h1 className="text-3xl font-black tracking-tight text-foreground mb-2">AI Usage Policy</h1>
          ...
          <ScrollArea className="h-[60vh] pr-6">
            <div className="prose prose-slate prose-sm max-w-none space-y-6">
              <Section title="1. Approved Provider">
                <p>Azure OpenAI is the approved production AI provider for Restops. We do not publish the specific underlying model version in this policy; the commitment is to Azure OpenAI as the provider, consistent with the Security Policy and Data Processing Addendum.</p>
              </Section>
              ...
              <Section title="6. Contact">
                <p>Questions about this AI Usage Policy can be sent to contact@mindfultechsol.com.</p>
                <p className="pt-2">
