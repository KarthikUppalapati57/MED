...
const saveMfaSetupSkip = (userId) => {
  if (!userId) return;
  try { localStorage.setItem(`${MFA_SETUP_SKIP_KEY_PREFIX}:${userId}`, 'true'); } catch {}
};

export default function MFASetupPage({ onSkip }) {
      ...
      <div className="w-full max-w-2xl animate-in fade-in zoom-in duration-500">
        <div className="text-center mb-8 space-y-2">
          ...
          <p className="text-muted-foreground max-w-sm mx-auto">
            Multi-factor authentication adds strong protection to your account. You can set it up now or skip and come back later from Security settings.
          </p>
        </div>
            ...
            <div className="grid md:grid-cols-5 h-full">
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-4">
                    ...
                    <li className="flex gap-3">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed">Enter the 6-digit code to verify and link your account, or skip this step for now.</p>
                    </li>
                  </ul>
                </div>
              ...
              <div className="md:col-span-3">
                <MFAEnrollment 
                  ...
                  onCancel={handleSkip}
                  cancelLabel="Skip and set up later"
                />
              </div>
            </div>
          </CardContent>
