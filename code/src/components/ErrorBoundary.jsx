          ...
          <div className="w-full max-w-md bg-card rounded-2xl shadow-lg p-8 space-y-6 border border-border text-center">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <button
                ...
                className="inline-flex items-center justify-center rounded-lg bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground hover:opacity-90 transition-colors"
              >
                Try Again
              </button>
              <button
