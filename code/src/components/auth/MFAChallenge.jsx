        ...
        <div className="p-8">
          ...
          <div className="space-y-6">
            <div className="flex justify-center">
              ...
              >
                <InputOTPGroup>
                  <InputOTPSlot index={0} className="border-border/80 bg-muted focus:ring-2 focus:ring-brand focus:border-transparent text-foreground" />
                  <InputOTPSlot index={1} className="border-border/80 bg-muted focus:ring-2 focus:ring-brand focus:border-transparent text-foreground" />
                  <InputOTPSlot index={2} className="border-border/80 bg-muted focus:ring-2 focus:ring-brand focus:border-transparent text-foreground" />
                </InputOTPGroup>
                <InputOTPSeparator className="text-muted-foreground/60" />
                <InputOTPGroup>
                  <InputOTPSlot index={3} className="border-border/80 bg-muted focus:ring-2 focus:ring-brand focus:border-transparent text-foreground" />
                  <InputOTPSlot index={4} className="border-border/80 bg-muted focus:ring-2 focus:ring-brand focus:border-transparent text-foreground" />
                  <InputOTPSlot index={5} className="border-border/80 bg-muted focus:ring-2 focus:ring-brand focus:border-transparent text-foreground" />
                </InputOTPGroup>
              </InputOTP>
            </div>
            ...
            <label className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-muted border border-border/40 cursor-pointer hover:bg-muted/80 transition-all duration-200">
              <input
                type="checkbox"
