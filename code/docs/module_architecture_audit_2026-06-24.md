...
| Notifications | `src/pages/Notifications.jsx`, bell in `Layout.jsx` | `notifications`, realtime insert/update | Partial | Navigation and user module list now use Notifications; link targets include stale payment query URLs. |
