# Developer - Full Platform Access Account

## Login

```text
Staging URL: ask admin / project owner
Email: qa.fullaccess.developer@restops.test
...
```text
Legal business name: QA Sandbox Company 109 LLC
Business type: LLC
Tax identifier type: EIN
Fake EIN: 99-8810977
Stored EIN last 4: 1097
Business email: qa.fullaccess.developer@restops.test
Business phone: +18655551109
Website: https://qa-sandbox-109.example.test
```
...
```text
Address line 1: 209 Sandbox Test Way
...
```text
Organization: QA Sandbox Org 109
Brand: QA Sandbox Brand 109
Location: QA Sandbox Location 109
```
...
```text
Bank name: Sandbox Bank 109
Account holder: QA Sandbox Company 109 LLC
Account type: checking
Seeded routing last 4: 1109
Seeded account last 4: 9109
Manual sandbox routing number: 222222226
Manual sandbox account number: 1000000109
```
