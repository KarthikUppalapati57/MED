# Developer - Onboarding Scenario Account

## Login

```text
Staging URL: ask admin / project owner
Email: qa.onboarding.developer@restops.test
...
```text
Person: Developer
Scenario: Full onboarding completed for developer checks
Use this account to: Developer checks for completed onboarding.
```

## Fake Business Details

```text
Legal business name: QA Sandbox Company 009 LLC
Business type: LLC
Tax identifier type: EIN
Fake EIN: 99-8800977
Stored EIN last 4: 0097
Business email: qa.onboarding.developer@restops.test
Business phone: +18655551009
Website: https://qa-sandbox-009.example.test
```
...
```text
Address line 1: 109 Sandbox Test Way
...
```text
Organization: QA Sandbox Org 009
Brand: QA Sandbox Brand 009
Location: QA Sandbox Location 009
```
...
```text
Bank name: Sandbox Bank 009
Account holder: QA Sandbox Company 009 LLC
Account type: checking
Seeded routing last 4: 1009
Seeded account last 4: 9009
Manual sandbox routing number: 222222226
Manual sandbox account number: 1000000009
```
