# Tester 7 - Full Platform Access Account

## Login

```text
Staging URL: ask admin / project owner
Email: qa.fullaccess.tester7@restops.test
...
```text
Legal business name: QA Sandbox Company 107 LLC
Business type: LLC
Tax identifier type: EIN
Fake EIN: 99-8810777
Stored EIN last 4: 1077
Business email: qa.fullaccess.tester7@restops.test
Business phone: +18655551107
Website: https://qa-sandbox-107.example.test
```
...
```text
Address line 1: 207 Sandbox Test Way
...
```text
Organization: QA Sandbox Org 107
Brand: QA Sandbox Brand 107
Location: QA Sandbox Location 107
```
...
```text
Bank name: Sandbox Bank 107
Account holder: QA Sandbox Company 107 LLC
Account type: checking
Seeded routing last 4: 1107
Seeded account last 4: 9107
Manual sandbox routing number: 222222226
Manual sandbox account number: 1000000107
```
