# Tester 1 - Full Platform Access Account

## Login

```text
Staging URL: ask admin / project owner
Email: qa.fullaccess.tester1@restops.test
...
```text
Legal business name: QA Sandbox Company 101 LLC
Business type: LLC
Tax identifier type: EIN
Fake EIN: 99-8810177
Stored EIN last 4: 1017
Business email: qa.fullaccess.tester1@restops.test
Business phone: +18655551101
Website: https://qa-sandbox-101.example.test
```
...
```text
Address line 1: 201 Sandbox Test Way
...
```text
Organization: QA Sandbox Org 101
Brand: QA Sandbox Brand 101
Location: QA Sandbox Location 101
```
...
```text
Bank name: Sandbox Bank 101
Account holder: QA Sandbox Company 101 LLC
Account type: checking
Seeded routing last 4: 1101
Seeded account last 4: 9101
Manual sandbox routing number: 222222226
Manual sandbox account number: 1000000101
```
