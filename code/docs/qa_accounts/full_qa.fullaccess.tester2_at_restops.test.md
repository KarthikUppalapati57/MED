# Tester 2 - Full Platform Access Account

## Login

```text
Staging URL: ask admin / project owner
Email: qa.fullaccess.tester2@restops.test
...
```text
Legal business name: QA Sandbox Company 102 LLC
Business type: LLC
Tax identifier type: EIN
Fake EIN: 99-8810277
Stored EIN last 4: 1027
Business email: qa.fullaccess.tester2@restops.test
Business phone: +18655551102
Website: https://qa-sandbox-102.example.test
```
...
```text
Address line 1: 202 Sandbox Test Way
...
```text
Organization: QA Sandbox Org 102
Brand: QA Sandbox Brand 102
Location: QA Sandbox Location 102
```
...
```text
Bank name: Sandbox Bank 102
Account holder: QA Sandbox Company 102 LLC
Account type: checking
Seeded routing last 4: 1102
Seeded account last 4: 9102
Manual sandbox routing number: 222222226
Manual sandbox account number: 1000000102
```
