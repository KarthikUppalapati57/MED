# Tester 5 - Full Platform Access Account

## Login

```text
Staging URL: ask admin / project owner
Email: qa.fullaccess.tester5@restops.test
...
```text
Legal business name: QA Sandbox Company 105 LLC
Business type: LLC
Tax identifier type: EIN
Fake EIN: 99-8810577
Stored EIN last 4: 1057
Business email: qa.fullaccess.tester5@restops.test
Business phone: +18655551105
Website: https://qa-sandbox-105.example.test
```
...
```text
Address line 1: 205 Sandbox Test Way
...
```text
Organization: QA Sandbox Org 105
Brand: QA Sandbox Brand 105
Location: QA Sandbox Location 105
```
...
```text
Bank name: Sandbox Bank 105
Account holder: QA Sandbox Company 105 LLC
Account type: checking
Seeded routing last 4: 1105
Seeded account last 4: 9105
Manual sandbox routing number: 222222226
Manual sandbox account number: 1000000105
```
