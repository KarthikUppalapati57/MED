# Tester 8 - Full Platform Access Account

## Login

```text
Staging URL: ask admin / project owner
Email: qa.fullaccess.tester8@restops.test
...
```text
Legal business name: QA Sandbox Company 108 LLC
Business type: LLC
Tax identifier type: EIN
Fake EIN: 99-8810877
Stored EIN last 4: 1087
Business email: qa.fullaccess.tester8@restops.test
Business phone: +18655551108
Website: https://qa-sandbox-108.example.test
```
...
```text
Address line 1: 208 Sandbox Test Way
...
```text
Organization: QA Sandbox Org 108
Brand: QA Sandbox Brand 108
Location: QA Sandbox Location 108
```
...
```text
Bank name: Sandbox Bank 108
Account holder: QA Sandbox Company 108 LLC
Account type: checking
Seeded routing last 4: 1108
Seeded account last 4: 9108
Manual sandbox routing number: 222222226
Manual sandbox account number: 1000000108
```
