...
COMMENT ON FUNCTION public.backfill_tenant_schema_missing_rows(TEXT, BOOLEAN) IS
  'Service-role tenant schema back-migration function. Dry-runs by default; when p_apply is true, copies missing id-based rows into shared public tables with organization_id forced from tenant_registry.';
