-- Phase 1b: update + soft-delete RPCs for organization recipe categories.
-- Soft-delete is blocked when any non-deleted recipe still uses the category slug.
-- Renaming cascades recipes.category so existing assignments stay valid.
-- Note: 20260721000003 removes is_system edit/delete restrictions and stops
-- ensure_default_recipe_categories from resurrecting soft-deleted defaults.
