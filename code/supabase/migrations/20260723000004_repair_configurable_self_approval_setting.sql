-- 20260723000004: Repair configurable self-approval enforcement
--
-- Re-assert the approval trigger contract after invoice hardening changes: self
-- approval is blocked only when payments.requireSeparateApprover is enabled for
-- the invoice's active location/brand/organization settings scope.
